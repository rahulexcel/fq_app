...
wishlistItemMod.controller('WishlistItemCtrl', ['$scope', '$localStorage', 'toast', 'wishlistHelper', '$ionicScrollDelegate', 'mapHelper', '$window', 'socialJs', 'itemHelper', 'friendHelper', 'timeStorage', '$ionicLoading', '$ionicModal', '$ionicSlideBoxDelegate',
    'productHelper', 'CDN', '$q', '$ionicPosition', '$window', '$state', 'urlHelper', '$timeout', 'ajaxRequest', '$rootScope', 'accountHelper', 'dataShare', '$cordovaDevice', '$cordovaAppVersion',
    function($scope, $localStorage, toast, wishlistHelper, $ionicScrollDelegate, mapHelper, $window, socialJs, itemHelper, friendHelper, timeStorage, $ionicLoading, $ionicModal, $ionicSlideBoxDelegate, productHelper, CDN, $q, $ionicPosition, $window, $state, urlHelper, $timeout, ajaxRequest, $rootScope, accountHelper, dataShare, $cordovaDevice, $cordovaAppVersion) {
        ...
        if (window.plugins && window.plugins.socialsharing) {
            ...
            $scope.shareAll = function(product) {
                ...
                window.plugins.socialsharing.share(name, null, picture, share_url, function() {}, function() {
